        ...
        <div class="row">
            <div class="col">
                <form method="POST">
                    ...
                    <hr>
                    <form action="latihanphp4_rendi.php" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-5">
                            <div class='custom-control custom-radio custom-control-inline'>
                                <input name='produk' id='radio_1' type="radio" class='custom-control-input' value='ac'>
                                <label for="radio_1" class='custom-control-label'>AC</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input name="produk" id="radio_2" type="radio" class="custom-control-input" value="kulkas"> 
                                <label for="radio_2" class="custom-control-label">Kulkas</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input name="produk" id="radio_3" type="radio" class="custom-control-input" value="mesin cuci"> 
            ...
            <div class="col-md-4 mt-5">
                <div class="list-group">
                    ...
                    <button type="button" class="list-group-item list-group-item-action">AC : 2000.000</button>
                    <button type="button" class="list-group-item list-group-item-action">Kulkas : 3000.000</button>
                    <button type="button" class="list-group-item list-group-item-action">Mesin Cuci : 4000.000</button>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if ($pilih_produk == 'ac') {
                            $totalbelanja = 2000000 * $jumlah_produk;
                        } elseif ($pilih_produk == 'kulkas') {
                            $totalbelanja = 3000000 * $jumlah_produk;
                        } elseif ($pilih_produk == 'mesin cuci') {
                            $totalbelanja = 4000000 * $jumlah_produk;
                        }
